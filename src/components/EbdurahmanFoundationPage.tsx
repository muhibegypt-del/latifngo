...
export const EbdurahmanFoundationPage = () => (
  <>
    ...
    <Section className="bg-white">
      <Reveal>
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-serif text-foundation-dark mb-8 tracking-tight">Empowerment Through Skills and Enterprise</h2>
      ...
      <Reveal delay={200}>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="group relative overflow-hidden bg-stone-100 aspect-[4/3] border border-stone-200 hover:border-foundation-primary/20 transition-all duration-300 hover:shadow-xl rounded-sm">
            <img
      ...
      <Reveal>
        <div className="max-w-3xl mx-auto text-center">
          <blockquote className="text-2xl md:text-3xl font-serif text-foundation-primary leading-snug mb-8 italic">
            "True empowerment means breaking cycles of dependency and building capacity for independence."
          </blockquote>
